...
namespace ClockStone
{
    public class AudioItemOverview : EditorWindow
    {
        ...
        {
            EditorWindow.GetWindow( typeof( AudioItemOverview ), false, "Audio Items" );
        }
        ...
        private GUIStyle _styleCopyIDButton;
        ...
        void OnGUI()
        {
            ...
            UIUtility.SearchFieldGUI( 150, ref _searchString );
        ...
        private void Initialise()
        {
            ...
            _styleCopyIDButton = new GUIStyle( EditorStyles.miniBoldLabel );
            _styleCopyIDButton.normal.background = _listItemBackgroundNormal0;
            _styleCopyIDButton.active.background = _listItemBackgroundClicked;

...
namespace PowerTools
{
	...
	public partial class SpriteAnimator : EditorWindow
	{
		...
		void LayoutPreview(Rect rect)
		{
			...
			{
				EditorGUI.LabelField(rect,"Disabled in Play Mode for Packed Sprites", new GUIStyle( EditorStyles.boldLabel) { alignment = TextAnchor.MiddleCenter, normal = { textColor = GameColors.White } } );
				return;
			}
#endif

...
public static class MathHelper
{
    ...
    public static void CreateQuestion(string question)
    {
        ...
        switch (PlayerLevelInfo.currentZone)
        {
            ...
            case 0:
                //L2.2
                numDec = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[1].ilos[1].ilo_parameters[3].default_value;

                //L5
                if (RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[4].selected == true)
                {
                    u = Random.Range(0, 2);
                    uE = Random.Range(0, 2);
                    if (u == 0)
        ...
        switch (question)
        {
            ...
            case "Naturales Potencia":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[0].ilo_parameters[3].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[0].ilo_parameters[4].default_value;
            ...
            case "Fracciones Suma":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[1].ilos[0].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[1].ilos[0].ilo_parameters[2].default_value;

                xn = Random.Range(min, max);
                xd = Random.Range(min, max);
                yn = Random.Range(min, max);
                if (RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[1].ilos[0].ilo_parameters[3].is_active)
                {
                    yd = xd;
                }
                else
            ...
            case "Decimales Suma":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[1].ilos[1].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[0].ilos[1].ilos[1].ilo_parameters[2].default_value;
            ...
            case "Ecuaciones Simples 1":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[1].ilos[0].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[1].ilos[0].ilo_parameters[2].default_value;
            ...
            //L9----------------------------------------------------------------------------------
            case "Sucesiones":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[1].ilos[1].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[1].ilos[1].ilo_parameters[2].default_value;
            ...
            //L13---------------------------------------------------------------------------------
            case "Area Triangulo":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[2].ilos[0].ilos[1].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[2].ilos[0].ilos[1].ilo_parameters[2].default_value;
            ...
            case "Perimetro Triangulo":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[2].ilos[0].ilos[0].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[2].ilos[0].ilos[0].ilo_parameters[2].default_value;
            ...
            case "Volumen Paralelepipedo":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[2].ilos[0].ilos[2].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[2].ilos[0].ilos[2].ilo_parameters[2].default_value;
            ...
            case "Media Aritmetica":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[3].ilos[3].ilos[0].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[3].ilos[3].ilos[0].ilo_parameters[2].default_value;
            ...
            case "Probabilidad":
                min = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[3].ilos[1].ilo_parameters[1].default_value;
                max = RemoteManager.Instance.RemoteSO.dgbl_features.ilos[3].ilos[1].ilo_parameters[2].default_value;
